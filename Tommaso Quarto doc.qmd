...
The Health dataset used in this study is constructed of data coming entirely from the CHR&R (County Health Rankings and Roadmaps) source. This program consists in providing annual data on health factors across almost the entirety of counties from the United States. The CHR&R provides data, evidence, guidance and examples to build awareness about the multiple factor influencing health conditions and disparities across the country. Furthermore, CHR&R puts an emphasis on the range of health-influencing measures offering crucial context about community specific health conditions and improvements. As an example, The "2025 Annual data release" includes over 80 health-related measures, and focuses on the impact of certain societal factors present in the United States on community conditions.